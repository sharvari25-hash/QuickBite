    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="card">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">₹{(deliveries.reduce((acc, d) => (d.status === "delivered" ? acc + d.amount : acc), 0) * USD_TO_INR).toFixed(2)}</p>
              </div>
          ...
          <div className="flex flex-row gap-8 flex-wrap md:flex-nowrap">
            {/* Sidebar */}
                        ...
                        <div key={delivery.id} className="border border-gray-200 rounded-lg p-4">
                          <div className="flex justify-between items-start mb-4">
                            ...
                            <div className="text-right">
                              <p className="font-bold">₹{(delivery.amount * USD_TO_INR).toFixed(2)}</p>
                              <span
            ...
            {activeTab === "active" && (
              <div className="card">
                ...
                {deliveries.filter((d) => d.status === "accepted" || d.status === "picked_up").length > 0 ? (
                  deliveries
                    .filter((d) => d.status === "accepted" || d.status === "picked_up")
                    .map((delivery) => (
                      <div key={delivery.id} className="border border-gray-200 rounded-lg p-4 mb-4">
                        <div className="flex justify-between items-start mb-4">
                          <div>
                            <h3 className="font-semibold">Order #{delivery.orderId}</h3>
                            <p className="text-gray-600">{delivery.restaurant}</p>
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600">Accepted deliveries will appear here</p>
                  </div>
                )}
              </div>
            )}
