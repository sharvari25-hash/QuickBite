      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-3 lg:px-4 py-4">
        ...
        <div className="flex flex-row gap-4 flex-wrap md:flex-nowrap">
          ...
          <div className="flex-1 w-full md:w-auto">
            ...
            {activeTab === "earnings" && (
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 space-y-4 animate-fadeInScale">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-lg font-semibold">
                  <div className="p-3 border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer">
                    <p className="text-gray-600">
                      Total Earnings
                    </p>
