...
public class AuthController {
    ...
    public DeliveryDetails addDeliveryPerson(@RequestBody DeliveryDetails deliveryDetails) {
		return deliveryService.addDeliveryPerson(deliveryDetails);	
    }
    
    @PostMapping("register/address")
    public AddressDetails addAddress(@RequestBody AddressDetails address) {
